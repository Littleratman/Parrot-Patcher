...
namespace parrot.Background
{
	...
	internal class ShowConsole : MonoBehaviour
	{
		...
		private async void Awake()
		{
			...
			Console.Title = "parrot.LOL ON TOP";
		...
		public void Logo()
		{
			...
			try
			{
				VersionJSON versionJSON = JsonConvert.DeserializeObject<VersionJSON[]>(new WebClient().DownloadString("https://tnuser.com/API/files/parrotVersion.json"))[0];
