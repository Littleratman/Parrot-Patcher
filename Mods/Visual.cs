...
using parrot.Patchers.VRRigPatchers;
using UnityEngine;
...
namespace parrot.Background.Mods
{
	...
	internal class Visual : Mod
	{
		...
		{
			if (!parrot.Patchers.VRRigPatchers.OnEnable.nameTags)
			{
				parrot.Patchers.VRRigPatchers.OnEnable.nameTags = true;
				foreach (VRRig vrrig in GorillaParent.instance.vrrigs)
				{
		...
		public static void StopNameTags()
		{
			if (parrot.Patchers.VRRigPatchers.OnEnable.nameTags)
			{
				parrot.Patchers.VRRigPatchers.OnEnable.nameTags = false;
				foreach (VRRig vrrig in GorillaParent.instance.vrrigs)
				{
					if (vrrig.GetComponent<NameTags>() != null)
					{
