...
namespace parrot.Background
{
	...
	internal class DiscordRPC
	{
		...
		{
			DiscordRPC.rpcAssembly = Assembly.Load(DiscordRPC.LoadEmbeddedResource("parrot.Resources.DiscordRPC.dll"));
			...
			type2.GetProperty("Details").SetValue(obj2, "Using parrot.lol Cheat in Gorilla Tag!");
			...
			type3.GetProperty("LargeImageText").SetValue(obj3, "parrot.lol");
