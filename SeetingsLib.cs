...
namespace parrot.Background
{
	...
	internal class SettingsLib : MonoBehaviour
	{
		...
		public static void Load()
		{
			...
			SettingsLib.ShowConsole = SettingsLib.cfgFile.Bind<bool>("Customization", "Show_Update_Console", true, "When you start your game parrot will open a console make this false to disable it!").Value;
		...
		public static ConfigFile cfgFile = new ConfigFile(Path.Combine(Paths.ConfigPath, "parrotconfig.cfg"), true);
